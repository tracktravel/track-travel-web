...
const Legales = () => {
    return (
        ...
        ENCABEZADOS
        Los encabezados de las secciones de estos términos y condiciones son solo para fines de referencia y no limitan ni afectan la interpretación de los términos y condiciones.
